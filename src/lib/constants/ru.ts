export const RU = {
  ...
  pages: {
    ...
    projects: {
      title: "Проекты",
      description:
        "Опубликованные проекты доступны в личном кабинете после входа. На этой странице собрана короткая навигация для новых участников."
    },
    join: {
    ...
    register: {
      title: "Регистрация",
      description:
        "Создайте аккаунт. Волонтёрская заявка подаётся после входа из личного кабинета."
    },
    app: {
  ...
  emptyStates: {
    ...
    admin:
      "Раздел пока не содержит отдельного рабочего процесса. Используйте доступные страницы панели для текущих операций."
  },
  messages: {
    phaseZero:
      "Раздел подготовлен для дальнейшего развития платформы.",
    adminPermissionNotice:
      "Этот раздел зарезервирован для будущего рабочего процесса и не выполняет действий.",
    profileRequired:
