    ...
    <>
      ...
      <div className="grid gap-6">
        ...
        <section className="rounded-lg border border-vista/40 bg-vista/15 p-4 text-sm leading-6 text-oxford">
          Посещаемость фиксирует только статус участника: был, не был или
          уважительная причина. Волонтёрские часы, сертификаты и достижения
          оформляются в отдельных разделах после подтверждения участия.
        </section>
      </div>
    </>
  );
